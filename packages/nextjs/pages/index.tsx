      ...
      <div className="flex bg-[url('/assets/gradient-gray.png')] bg-[length:100%_100%] flex-col flex-grow pt-10 lg:py-auto max-w-[100vw]">
          ...
          <div className="px-5 py-20">
            <h1 className="text-center mt-4 mb-8">
              ...
              <span className="block text-6xl font-bold mb-2">
                <span className="text-8xl">DEvents</span>
              </span>
        ...
        <div className="px-5 py-20">
          <h2 className="text-center mb-8">
            ...
            <span className="block text-4xl font-bold mb-2">Fast. Simple. Easy.</span>
            <span className="block text-2xl mb-2">Get started in minutes.</span>
          </h2>
        </div>
        <div className="container mx-auto flex flex-col p-6">
          <h2 className="py-4 text-3xl font-bold text-center">Event Ticketing Made Simple</h2>
            ...
            <div className="grid justify-center grid-cols-4 p-8 mx-auto space-y-8 lg:space-y-0">
              ...
              <div className="flex flex-col justify-center max-w-3xl text-center col-span-full lg:col-span-3 lg:text-left">
                ...
                <span className="text-xl font-bold md:text-2xl">
                  You will need a valid ERC-721 contract as ticket to your event
                </span>
                <span className="mt-4 dark:text-gray-300">
                  If you already have a contract to use as a ticket, you can use that. If not, you can use our ticket
                  factory.
                </span>
              </div>
            </div>
